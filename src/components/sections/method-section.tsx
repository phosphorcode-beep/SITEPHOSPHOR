            ...
            {phases.map((p, i) => {
              ...
              return (
                ...
                >
                  ...
                  {i === 0 && (
                    <motion.div
                      className="mb-md md:col-start-2 md:row-start-1 md:mb-0 md:flex md:items-center"
                      variants={card(false)}
                      initial="hidden"
                      whileInView="visible"
                  ...
                  {i === 1 && (
                    <motion.div
                      className="mb-md md:col-start-1 md:row-start-1 md:mb-0 md:flex md:items-center md:justify-center"
                      variants={card(true)}
                      initial="hidden"
                      whileInView="visible"
                      viewport={{ once: true, amount: 0.4 }}
                    >
                      <div className="relative mx-auto flex h-[320px] w-full items-center justify-center overflow-visible md:h-[480px]">
                  ...
                  {i === phases.length - 1 && (
                    <motion.div
                      className="mb-md md:col-start-1 md:mb-0 md:flex md:items-center"
                      variants={card(true)}
                      initial="hidden"
                      whileInView="visible"
                      viewport={{ once: true, amount: 0.4 }}
